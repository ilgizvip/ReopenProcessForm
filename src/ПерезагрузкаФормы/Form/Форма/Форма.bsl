...
&НаКлиенте
Процедура ОткрытьФормуСсылки(Команда)
	
	ПараметрыОткрытияФормы = Новый Структура();
	ПараметрыОткрытияФормы.Вставить("Ключ", Ссылка);
	
	ОткрытьФорму("ВнешняяОбработка.ПерезагрузкаФормы.Форма.Форма", ПараметрыОткрытияФормы);
